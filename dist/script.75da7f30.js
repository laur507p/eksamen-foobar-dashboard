...
function showOrders(orderData, servingData, convertedOrders) {
  ...
  var stringOrders = JSON.stringify(convertedOrders);
  console.log(stringOrders); // clear container
  ...
  servingData.forEach(function (order) {
    ...
    convertedOrders.forEach(function (beer) {
      var stringOrders = JSON.stringify(beer);
